...
def load_model(args):
    if 'w11wo/sundanese-roberta-base' in args['model_checkpoint']:
        ...
        # Instantiate model
        model = RobertaForSequenceClassification.from_pretrained(args['model_checkpoint'], config=config)
